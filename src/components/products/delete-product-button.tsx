...
import { deleteProductWithResultAction } from "@/app/produk/actions";
...
export function DeleteProductButton({
  ...
  function handleDelete() {
    startTransition(async () => {
      ...
      const result = await deleteProductWithResultAction(formData);

      if (!result.success) {
        setErrorMessage(
          result.message || "Produk gagal dihapus. Silakan coba lagi."
        );
              ...
              <>
                ...
                <div className="flex flex-col items-center px-8 pb-8 pt-10 text-center">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-400">
                    Jika produk sudah digunakan dalam transaksi, penghapusan
                    bisa ditolak oleh database.
                  </p>
            ...
            {dialogState === "error" ? (
              <div className="flex flex-col items-center px-8 pb-10 pt-10 text-center">
                <div className="flex h-28 w-28 items-center justify-center rounded-full border-4 border-red-100 bg-white">
                  <X className="h-14 w-14 text-red-500" strokeWidth={2} />
                </div>
                ...
                <p className="mt-5 text-[16px] leading-7 text-slate-500">
                  {errorMessage || "Produk gagal dihapus."}
                </p>
