...
export function SaleForm({
  ...
  const firstAiDiscount =
    aiDiscountMap.get(firstProductId);
  ...
  const [rows, setRows] = useState<SaleRow[]>([
    {
      ...
      discountPercentage: clampDiscount(
        Number(
          firstAiDiscount?.discountPercentage || 0
        )
      ),
      discountSource: firstAiDiscount
        ? "ai"
        : "manual",
    },
  ]);
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-muted-foreground">
                Beberapa produk overstock
                memiliki rekomendasi
                diskon dari AI. Saat
                produk dipilih, diskon
                otomatis terisi dan tetap
                bisa diubah manual oleh
                kasir.
              </p>
            </div>
          </div>
