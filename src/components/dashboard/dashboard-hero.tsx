  ...
  return (
    <AnimatedContainer>
      <GlassPanel className="p-6 md:p-8">
        ...
        <div className="absolute bottom-0 right-32 h-56 w-56 rounded-full bg-violet-500/20 blur-3xl" />

        <div className="relative grid gap-8 lg:grid-cols-[1.4fr_0.7fr] lg:items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-xs font-medium uppercase tracking-[0.25em] text-cyan-300">
